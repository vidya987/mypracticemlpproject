...
import com.hexaware.canteenmanagement.model.*;
import com.hexaware.canteenmanagement.factory.*;
...
public class MenuRest {/*
  ...
  public final String addFood(@PathParam("fname") final int fname,
       final Menu ld, @PathParam("fquant") final int fquant, @PathParam("fprice") final int fprice) throws ParseException {
